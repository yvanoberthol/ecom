                                ...
                                <div class="p-4">
                                    ...
                                    @if(Auth::check())
                                        ...
                                        @foreach ($detailedProduct->orderDetails as $key => $orderDetail)
                                            @if($orderDetail->order !== null && $orderDetail->delivery_status === 'delivered' &&
                                            $orderDetail->order->user_id === Auth::user()->id  && \App\Models\Review::where('user_id', Auth::user()->id)->where('product_id', $detailedProduct->id)->first() === null)
                                                @php
                                                    $commentable = true;
                                                @endphp
                                            @endif
