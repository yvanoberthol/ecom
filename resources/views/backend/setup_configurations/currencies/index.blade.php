                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control aiz-selectpicker" name="symbol_format">
                                <option value="1" @if((int)get_setting('symbol_format') === 1) selected @endif>[Symbol][Amount]</option>
                                <option value="2" @if((int)get_setting('symbol_format') === 2) selected @endif>[Amount][Symbol]</option>
                                <option value="3" @if((int)get_setting('symbol_format') === 3) selected @endif>[Symbol] [Amount]</option>
                                <option value="4" @if((int)get_setting('symbol_format') === 4) selected @endif>[Amount] [Symbol]</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control aiz-selectpicker" name="decimal_separator">
                                <option value="1" @if((int)get_setting('decimal_separator') === 1) selected @endif>1,23,456</option>
                                <option value="2" @if((int)get_setting('decimal_separator') === 2) selected @endif>1.23.456</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control aiz-selectpicker" name="no_of_decimals">
                                <option value="0" @if((int)get_setting('no_of_decimals') === 0) selected @endif>12345</option>
                                <option value="1" @if((int)get_setting('no_of_decimals') === 1) selected @endif>1234.5</option>
                                <option value="2" @if((int)get_setting('no_of_decimals') === 2) selected @endif>123.45</option>
                                <option value="3" @if((int)get_setting('no_of_decimals') === 3) selected @endif>12.345</option>
                            </select>
                        </div>
                    </div>
