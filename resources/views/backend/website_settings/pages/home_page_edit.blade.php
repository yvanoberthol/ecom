...
<div class="row">
	<div class="col-xl-10 mx-auto">
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">{{ translate('Block Welcome') }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label class="col-md-2 col-from-label">{{translate('Welcome description')}}</label>
                        <div class="col-md-10">
                            <input type="hidden" name="types[][{{ $lang }}]" value="welcome_description">
                            <textarea class="aiz-text-editor" name="welcome_description">
                                {!! get_setting('welcome_description',null,$lang); !!}
                            </textarea>
                        </div>
                    </div>
                    <div class="text-right">
