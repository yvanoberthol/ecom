...
class ConversationController extends Controller
{
    ...
    {
        if ((int)BusinessSetting::where('type', 'conversation_system')->first()->value === 1) {
    ...
    public function store(Request $request)
    {
        ...
        $conversation->receiver_id = User::where('user_type', 'admin')->first()->id;
        ...
        if($conversation->save()) {
            ...
            if ($message->save()) {
                $this->send_message_to_seller($conversation, $message);
            }
        }
    ...
    public function send_message_to_seller($conversation, $message)
    {
