...
class ProductController extends Controller
{
    ...
    public function all_products(Request $request)
    {
        ...
        if ($request->user_id !== null && $request->has('user_id')) {
    ...
    public function store(Request $request)
    {
        ...
        if($request->has('choice_no')){
            foreach ($request->choice_no as $key => $no) {
                ...
                foreach ($request[$str] as $eachValue) {
        ...
        if(count($combinations[0]) > 0){
            ...
            foreach ($combinations as $combination){
                ...
                foreach ($combination as $key => $item){
                    ...
                    else if($request->has('colors_active') && $request->has('colors') && count($request->colors) > 0){
    ...
    public function update(Request $request, $id)
    {
        ...
        if(count($combinations[0]) > 0){
            ...
            foreach ($combinations as $combination){
                ...
                $priceStrFormated = 'price_'.str_replace('.', '_', $str);
                if(isset($request[$priceStrFormated])) {
