...
namespace Unicodeveloper\Paystack\Facades {
    ...
    use Unicodeveloper\Paystack\json;
    use Unicodeveloper\Paystack\subaccount;
...
namespace Anand\LaravelPaytmWallet\Facades {
    ...
    use Anand\LaravelPaytmWallet\PaytmWalletManager;
    use Closure;
    use Illuminate\Contracts\Container\Container;
    use InvalidArgumentException;
    ...
    class PaytmWallet
    {
        ...
        public static function with($driver)
        {
            /** @var PaytmWalletManager $instance */
            return $instance->with($driver);
        }
...
namespace SimpleSoftwareIO\QrCode\Facades {
    ...
    use SimpleSoftwareIO\QrCode\SimpleSoftwareIO\QrCode\boolean;
...
namespace Laracon21\Combinations {
    ...
    class CombinationsFacade
    {
        ...
        {
            return Combinations::makeCombinations($arrays);
        }
...
namespace {
    ...
    use Illuminate\Support\Collection;
    use Illuminate\Support\LazyCollection;
    use Laracon21\Colorcodeconverter\ColorcodeconverterFacade;
    use Laracon21\Combinations\CombinationsFacade;
    use Laracon21\Timezones\TimezonesFacade;
    use MehediIitdu\CoreComponentRepository\CoreComponentRepositoryFacade;
    ...
    class Colorcodeconverter extends ColorcodeconverterFacade
    {
    }

    class Combinations extends CombinationsFacade
    {
    }

    class Timezones extends TimezonesFacade
    {
    }

    class CoreComponentRepository extends CoreComponentRepositoryFacade
    {
    }

    class DNS1D extends DNS1DFacade
    {
    }

    class DNS2D extends DNS2DFacade
    {
    }
